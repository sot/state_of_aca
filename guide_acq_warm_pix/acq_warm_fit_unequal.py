...
plotdir = "./acq_summary_plots_unequal"
...
f = open('acq_warm_fit_unequal.dat', 'w')
f.write(",".join(cols))
f.write("\n")
for d in data_rec:
...
plt.tight_layout()
plt.grid()
plt.savefig('acq_fail_warm_scale_unequal.png')
fig=plt.figure(figsize=(5, 3))
...
plt.tight_layout()
plt.grid()
plt.savefig('acq_fail_warm_offset_unequal.png')
